...
def dashboard():
    ...
    if request.method == 'POST':
        ...
        diabetes = request.form.get('diabetes', 'Unknown')

        input_data = [[gender, age, hypertension, heart_disease, smoking_history, bmi, HbA1c_level, blood_glucose_level,diabetes]]
